  ...
  const recentProducts = [
    {
      ...
      price: 4999,
      quantity: 15,
      images: ["https://images.unsplash.com/photo-1567016432779-094069958ea5?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8c29mYXxlbnwwfHwwfHx8MA%3D%3D"],
      sales: 120,
    },
    {
      _id: "prod002",
  ...
  return (
    <div className="max-w-7xl mx-auto px-2 mb-8">
      ...
      <div className="flex mb-4">
        <h2 className="text-2xl font-bold text-brandOrange">Recently Viewed</h2>
      </div>
